 ...
 * @param {T | null} [value=null] The initial value or `null` if not yet loaded.
 * @param {boolean} [isLoading=false] A flag indicating whether the value is in a loading state.
 * @param {E | null} [error=null] The error if the value failed to load, or `null` if no error.
